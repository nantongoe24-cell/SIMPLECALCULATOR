...
class SavingsCalculator
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Assigned Rate:      {interestRate / 100:P} (based on principal tier)");
        ...
        while (year <= years)
        {
            ...
            Console.WriteLine($"Year {year}: Interest = {yearlyInterest:C}, Balance = {balance:C}");
        ...
        // --- Output ---
        Console.WriteLine();
        Console.WriteLine($"Final Balance after {years} year(s): {balance:C}");
    }
}
